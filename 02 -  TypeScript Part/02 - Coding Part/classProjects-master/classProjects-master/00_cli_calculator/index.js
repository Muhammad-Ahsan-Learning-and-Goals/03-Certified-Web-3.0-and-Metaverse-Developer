...
function getInputFromUser() {
    return __awaiter(this, void 0, void 0, function () {
        var answers, firstNumber, secondNumber, confirm;
            ...
            switch (_a.label) {
                ...
                case 1:
                    ...
                    switch (answers.operation) {
                        case "+":
                            console.log("Result: ".concat(firstNumber + secondNumber));
                            break;
                        case "-":
                            console.log("Result: ".concat(firstNumber - secondNumber));
                            break;
                        ...
                        case "%":
                            ...
                            break;
                        case "^":
                            console.log("Result: ".concat(Math.pow(firstNumber, secondNumber)));
                            break;
                        default:
                            break;
                    }
